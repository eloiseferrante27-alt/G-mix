...
class Decision(models.Model):
    ...
    turn = models.ForeignKey('game_sessions.Turn', on_delete=models.CASCADE, related_name='decisions')
    team = models.ForeignKey('game_sessions.Team', on_delete=models.CASCADE, related_name='decisions')
...
class TurnResult(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    turn = models.ForeignKey('game_sessions.Turn', on_delete=models.CASCADE, related_name='results')
    team = models.ForeignKey('game_sessions.Team', on_delete=models.CASCADE, related_name='results')
